...
// MDD - Uncomment this line to set your data to the USB port
#define LOG_PORT SERIAL_PORT_USBVIRTUAL
// MDD - Uncomment this to send to the UART port
...
float ACCEL_X_MIN = -256;
float ACCEL_X_MAX = 254;
float ACCEL_Y_MIN = -254;
float ACCEL_Y_MAX = 268;
float ACCEL_Z_MIN = -262;
