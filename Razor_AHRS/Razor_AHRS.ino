...
#define ACCEL_Z_MIN ((float) -266)
#define ACCEL_Z_MAX ((float) 271)
...
// Added for Tonga Surfbee
// #define CALIBRATION__MAGN_USE_EXTENDED true
// const float magn_ellipsoid_center[3] = {99.9018, 10.7645, -134.077};
// const float magn_ellipsoid_transform[3][3] = {{0.887658, 0.0112915, 0.00959681}, {0.0112915, 0.868006, 0.0184887}, {0.00959681, 0.0184887, 0.996288}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -4.89)
#define GYRO_AVERAGE_OFFSET_Y ((float) 34.6)
#define GYRO_AVERAGE_OFFSET_Z ((float) -1.74)
